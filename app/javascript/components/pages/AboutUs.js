            ...
            <div className='three-column-item aboutus'>
                ...
                >
                    ...
                    <CardBody>
                        ...
                        <CardText className='aboutus-description'>
                        I’m a Web Developer with a focus on full stack applications, but still exploring other technologies that catch my interest! Currently working on building projects with API’s and backend frameworks. I enjoy all types of music, especially live. My hobbies include; snowboarding, surfing, hiking, rock climbing, trail ultra-runs, video games, and photography. If you’re looking for a developer to add to your team, I’d love to hear from you!
                        </CardText>
                            <span className='aboutus-icons-bg'>
